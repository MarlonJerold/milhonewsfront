...
const VisuallyHidden: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <span style={{ position: 'absolute', width: '1px', height: '1px', margin: '-1px', padding: '0', border: '0', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', wordWrap: 'normal' }}>
    {children}
  </span>
);
  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      >
        ...
        <SheetHeader>
          <SheetTitle>
            <VisuallyHidden>Title of the Sheet</VisuallyHidden>
          </SheetTitle>
        </SheetHeader>
        {children}
      </SheetPrimitive.Content>
